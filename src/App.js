  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        <Button onClick={handleShowAddFriendToggle}>
          {showAddFriend ? "Close" : "Add Friend"}
        </Button>
      </div>

      {selectedFriend && (
        <FormSplitBill key={selectedFriend.id}  selectedFriend={selectedFriend} onSplit={handleSplit} />
      )}
    </div>
  );
}
...
function FormSplitBill({ selectedFriend, onSplit }) {
  ...
  const friendpaid = bill - paidByUser;
